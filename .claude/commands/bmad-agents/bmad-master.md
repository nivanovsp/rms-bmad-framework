...
mlda_protocol:
  paradigm:
    ...
    - All tasks reference DOC-IDs - navigate to gather full context
    - Master executor can navigate across all domains
  activation:
  ...
  navigation:
    ...
    - Default depth limit 4 (broad access across domains)
commands:
