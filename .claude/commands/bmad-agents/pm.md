...
mlda_protocol:
  paradigm:
    ...
    - PRDs and requirements reference DOC-IDs - navigate to understand full context
    - PM creates and connects documentation nodes in the knowledge graph
  activation:
  ...
  navigation:
    ...
    - Default depth limit 3 for PM (requirements-focused)
  document_creation:
    - Always create topic documents with DOC-IDs as entry points
    - PRDs reference related documentation via DOC-IDs
    - Ensure new documents have relationships defined in sidecars
